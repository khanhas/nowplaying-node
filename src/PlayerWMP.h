...
private:
  class CRemoteHost : public IServiceProvider,
  ...
  public:
    ...
    // IUnknown
    virtual HRESULT STDMETHODCALLTYPE QueryInterface(REFIID uuid,
    ...
    void STDMETHODCALLTYPE
    PlaylistCollectionPlaylistAdded(BSTR bstrPlaylistName) {}
    void STDMETHODCALLTYPE
    ...
    void STDMETHODCALLTYPE Click(short nButton, short nShiftState, long fX,
                                 long fY) {}
    void STDMETHODCALLTYPE DoubleClick(short nButton, short nShiftState,
                                       long fX, long fY) {}

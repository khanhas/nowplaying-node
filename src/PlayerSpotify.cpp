...
**
*/
PlayerSpotify::PlayerSpotify() : Player(), m_Window(), m_LastCheckTime(0) {}

/*
** Destructor.
**
*/
PlayerSpotify::~PlayerSpotify() { c_Player = nullptr; }
...
void PlayerSpotify::OpenPlayer(std::wstring &path) {
  if (!m_Initialized) {
    if (path.empty()) {
      ...
      HKEY hKey;
      RegOpenKeyEx(HKEY_CLASSES_ROOT, L"spotify\\DefaultIcon", 0,

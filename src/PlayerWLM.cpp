...
**
*/
PlayerWLM::PlayerWLM() : Player(), m_Window() {
  ...
  // Create dummy window
  m_Window = CreateWindow(L"MsnMsgrUIManager", L"", WS_DISABLED, CW_USEDEFAULT,
                          CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, nullptr,
                          nullptr, g_Instance, this);
...
LRESULT CALLBACK PlayerWLM::WndProc(HWND hWnd, UINT msg, WPARAM wParam,
                                    LPARAM lParam) {
...
**
*/
void PlayerWLM::Play() { SendKeyInput(VK_MEDIA_PLAY_PAUSE); }

/*
** Handles the Stop bang.
**
*/
void PlayerWLM::Stop() { SendKeyInput(VK_MEDIA_STOP); }

/*
** Handles the Next bang.
**
*/
void PlayerWLM::Next() { SendKeyInput(VK_MEDIA_NEXT_TRACK); }

/*
** Handles the Previous bang.
**
*/
void PlayerWLM::Previous() { SendKeyInput(VK_MEDIA_PREV_TRACK); }

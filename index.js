...
const np = require("./build/Release/NowPlayingjs.node");
var PlayerName;
(function(PlayerName) {
...
class NowPlaying {
   ...
   * Closes the player.
   */
  closePlayer() { this.instance.closePlayer(); };
  /**
   * Current album.
   */
  getAlbum() { return this.instance.getAlbum(); };
  /**
   * Track artist.
   */
  getArtist() { return this.instance.getArtist(); };
  /**
   * Path to cover art.
   */
  getCoverPath() { return this.instance.getCoverPath(); };
  /**
   * Total length of track in seconds.
   */
  getDuration() { return this.instance.getDuration(); };
  /**
   * Path to the playing media file.
   */
  getFilePath() { return this.instance.getFilePath(); };
  /**
   * Track genre.
   */
  getGenre() { return this.instance.getGenre(); };
  /**
   * Track number.
   */
  getNumber() { return this.instance.getNumber(); };
  /**
   * Current position in track in seconds.
   */
  getPosition() { return this.instance.getPosition(); };
  /**
   * Percentage of track completed.
   */
  getProgress() { return this.instance.getProgress(); };
  /**
   * Rating of current track (0 to 5).
   */
  getRating() { return this.instance.getRating(); };
  /**
   * `false` if repeat/loop track is off, `true` if on.
   */
  getRepeat() { return this.instance.getRepeat(); };
  /**
   * `false` if shuffle/random tracks is off, `true` if on.
   */
  getShuffle() { return this.instance.getShuffle(); };
  /**
   ...
   */
  getStatus() { return this.instance.getStatus(); };
  /**
   * Track title.
   */
  getTitle() { return this.instance.getTitle(); };
  /**
   * From 0 to 100.
   */
  getVolume() { return this.instance.getVolume(); };
  /**
   * Track year.
   */
  getYear() { return this.instance.getYear(); };
  /**
   ...
   */
  openPlayer() { this.instance.openPlayer(); };
  /**
   * Pause current track.
   */
   ...
   */
  previous() { this.instance.previous(); };
  /**
   * Change track position.
   * @param position in second
   */
  setPosition(position) { this.instance.setPosition(position); };
  /**
   * Change track rating.
   * @param rating  `0` (no rating) to `5` (maximum rating)
   */
  setRating(rating) { this.instance.setRating(rating); };
  /**
   * Change player repeat state.
   * @param isRepeat `true`: repeat on. `false`: repeat off.
   */
  setRepeat(isRepeat) { this.instance.setRepeat(isRepeat); };
  /**
   * Change player shuffle state.
   * @param isShuffle `true`: shuffle on. `false`: shuffle off.
   */
  setShuffle(isShuffle) { this.instance.setShuffle(isShuffle); };
  /**
   * Change player volume level.
   * @param level 0 to 100.
   */
  setVolume(level) { this.instance.setVolume(level); };
  /**
   * Stop current track.
   */
